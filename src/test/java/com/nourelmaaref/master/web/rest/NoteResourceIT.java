...
class NoteResourceIT {
    ...
    private static final Double DEFAULT_NOTE_EXAM = 1D;
    private static final Double UPDATED_NOTE_EXAM = 2D;
    ...
    public static Note createEntity(EntityManager em) {
        Note note = new Note().noteExam(DEFAULT_NOTE_EXAM).remarque(DEFAULT_REMARQUE);
        return note;
    }
    ...
    public static Note createUpdatedEntity(EntityManager em) {
        Note note = new Note().noteExam(UPDATED_NOTE_EXAM).remarque(UPDATED_REMARQUE);
        return note;
    }
    ...
    void createNote() throws Exception {
        ...
        assertThat(testNote.getNoteExam()).isEqualTo(DEFAULT_NOTE_EXAM);
    ...
    void getAllNotes() throws Exception {
        ...
        restNoteMockMvc
            ...
            .andExpect(jsonPath("$.[*].noteExam").value(hasItem(DEFAULT_NOTE_EXAM.doubleValue())))
    ...
    void getNote() throws Exception {
        ...
        restNoteMockMvc
            ...
            .andExpect(jsonPath("$.noteExam").value(DEFAULT_NOTE_EXAM.doubleValue()))
    ...
    void putExistingNote() throws Exception {
        ...
        updatedNote.noteExam(UPDATED_NOTE_EXAM).remarque(UPDATED_REMARQUE);
        ...
        Note testNote = noteList.get(noteList.size() - 1);
        assertThat(testNote.getNoteExam()).isEqualTo(UPDATED_NOTE_EXAM);
    ...
    void partialUpdateNoteWithPatch() throws Exception {
        ...
        partialUpdatedNote.noteExam(UPDATED_NOTE_EXAM);
    ...
    void fullUpdateNoteWithPatch() throws Exception {
        ...
        partialUpdatedNote.noteExam(UPDATED_NOTE_EXAM).remarque(UPDATED_REMARQUE);
