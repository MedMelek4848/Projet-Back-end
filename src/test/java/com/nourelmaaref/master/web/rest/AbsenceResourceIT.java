...
import com.nourelmaaref.master.repository.AbsenceRepository;
import com.nourelmaaref.master.service.AbsenceService;
import com.nourelmaaref.master.service.dto.AbsenceDTO;
import com.nourelmaaref.master.service.mapper.AbsenceMapper;
...
class AbsenceResourceIT {
    ...
    private static final Integer DEFAULT_NOMBRE_ABSENCE = 1;
    private static final Integer UPDATED_NOMBRE_ABSENCE = 2;
    ...
    public static Absence createEntity(EntityManager em) {
        Absence absence = new Absence()
            ...
            .justifie(DEFAULT_JUSTIFIE)
            .commentaire(DEFAULT_COMMENTAIRE)
            .nombreAbsence(DEFAULT_NOMBRE_ABSENCE);
        return absence;
    }
    ...
    public static Absence createUpdatedEntity(EntityManager em) {
        Absence absence = new Absence()
            ...
            .justifie(UPDATED_JUSTIFIE)
            .commentaire(UPDATED_COMMENTAIRE)
            .nombreAbsence(UPDATED_NOMBRE_ABSENCE);
        return absence;
    }
    ...
    void createAbsence() throws Exception {
        ...
        assertThat(testAbsence.getNombreAbsence()).isEqualTo(DEFAULT_NOMBRE_ABSENCE);
    }
    ...
    void getAllAbsences() throws Exception {
        ...
        restAbsenceMockMvc
            ...
            .andExpect(jsonPath("$.[*].nombreAbsence").value(hasItem(DEFAULT_NOMBRE_ABSENCE)));
    }
    ...
    void getAbsence() throws Exception {
        ...
        restAbsenceMockMvc
            ...
            .andExpect(jsonPath("$.nombreAbsence").value(DEFAULT_NOMBRE_ABSENCE));
    }
    ...
    void putExistingAbsence() throws Exception {
        ...
        assertThat(testAbsence.getNombreAbsence()).isEqualTo(UPDATED_NOMBRE_ABSENCE);
    }
    ...
    void partialUpdateAbsenceWithPatch() throws Exception {
        ...
        partialUpdatedAbsence.dateAbsence(UPDATED_DATE_ABSENCE).commentaire(UPDATED_COMMENTAIRE).nombreAbsence(UPDATED_NOMBRE_ABSENCE);
