...
import com.nourelmaaref.master.repository.ClasseRepository;
import com.nourelmaaref.master.service.dto.ClasseDTO;
import com.nourelmaaref.master.service.mapper.ClasseMapper;
...
class ClasseResourceIT {
    ...
    public static Classe createEntity(EntityManager em) {
        Classe classe = new Classe().nomClasse(DEFAULT_NOM_CLASSE).nombreEleves(DEFAULT_NOMBRE_ELEVES);
        return classe;
    }
    ...
    public static Classe createUpdatedEntity(EntityManager em) {
        Classe classe = new Classe().nomClasse(UPDATED_NOM_CLASSE).nombreEleves(UPDATED_NOMBRE_ELEVES);
        return classe;
    }
    ...
    void createClasse() throws Exception {
        ...
        assertThat(testClasse.getNombreEleves()).isEqualTo(DEFAULT_NOMBRE_ELEVES);
    }
    ...
    void putExistingClasse() throws Exception {
        ...
        updatedClasse.nomClasse(UPDATED_NOM_CLASSE).nombreEleves(UPDATED_NOMBRE_ELEVES);
        ...
        assertThat(testClasse.getNombreEleves()).isEqualTo(UPDATED_NOMBRE_ELEVES);
    }
    ...
    void fullUpdateClasseWithPatch() throws Exception {
        ...
        partialUpdatedClasse.nomClasse(UPDATED_NOM_CLASSE).nombreEleves(UPDATED_NOMBRE_ELEVES);
