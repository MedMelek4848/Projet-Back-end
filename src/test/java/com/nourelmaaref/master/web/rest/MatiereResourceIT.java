...
import com.nourelmaaref.master.repository.MatiereRepository;
import com.nourelmaaref.master.service.dto.MatiereDTO;
import com.nourelmaaref.master.service.mapper.MatiereMapper;
...
class MatiereResourceIT {
    ...
    private static final Integer DEFAULT_NOMBRE_EXAMEN = 1;
    private static final Integer UPDATED_NOMBRE_EXAMEN = 2;
    ...
    public static Matiere createEntity(EntityManager em) {
        Matiere matiere = new Matiere()
            ...
            .nombreExamen(DEFAULT_NOMBRE_EXAMEN);
        return matiere;
    }
    ...
    public static Matiere createUpdatedEntity(EntityManager em) {
        Matiere matiere = new Matiere()
            ...
            .nombreExamen(UPDATED_NOMBRE_EXAMEN);
        return matiere;
    }
    ...
    void createMatiere() throws Exception {
        ...
        assertThat(testMatiere.getNombreHeures()).isEqualTo(DEFAULT_NOMBRE_HEURES);
        assertThat(testMatiere.getNombreExamen()).isEqualTo(DEFAULT_NOMBRE_EXAMEN);
    }
    ...
    void getAllMatieres() throws Exception {
        ...
        restMatiereMockMvc
            ...
            .andExpect(jsonPath("$.[*].nombreExamen").value(hasItem(DEFAULT_NOMBRE_EXAMEN)));
    }
    ...
    void getMatiere() throws Exception {
        ...
        restMatiereMockMvc
            ...
            .andExpect(jsonPath("$.nombreExamen").value(DEFAULT_NOMBRE_EXAMEN));
    }
    ...
    void putExistingMatiere() throws Exception {
        ...
        assertThat(testMatiere.getNombreHeures()).isEqualTo(UPDATED_NOMBRE_HEURES);
        assertThat(testMatiere.getNombreExamen()).isEqualTo(UPDATED_NOMBRE_EXAMEN);
    }
    ...
    void partialUpdateMatiereWithPatch() throws Exception {
        ...
        partialUpdatedMatiere.coefficient(UPDATED_COEFFICIENT).nombreExamen(UPDATED_NOMBRE_EXAMEN);
