...
/**
 * REST controller for managing {@link com.nourelmaaref.master.domain.Cours}.
 */
@RestController
@RequestMapping("/api")
public class CoursResource {
    ...
    public ResponseEntity<CoursDTO> partialUpdateCours(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, coursDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<CoursDTO>> getAllCours(
        ...
        Page<CoursDTO> page;
        if (eagerload) {
            page = coursService.findAllWithEagerRelationships(pageable);
        } else {
