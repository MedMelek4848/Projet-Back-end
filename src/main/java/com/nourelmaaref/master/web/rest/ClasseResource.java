...
import com.nourelmaaref.master.service.ClasseService;
...
/**
 * REST controller for managing {@link com.nourelmaaref.master.domain.Classe}.
 */
@RestController
@RequestMapping("/api")
public class ClasseResource {
     ...
     */
    @GetMapping("/classes")
    public ResponseEntity<List<ClasseDTO>> getAllClasses(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
