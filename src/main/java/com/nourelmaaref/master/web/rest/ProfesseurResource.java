...
import com.nourelmaaref.master.service.ProfesseurService;
...
/**
 * REST controller for managing {@link com.nourelmaaref.master.domain.Professeur}.
 */
@RestController
@RequestMapping("/api")
public class ProfesseurResource {
    ...
    public ResponseEntity<List<ProfesseurDTO>> getAllProfesseurs(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
