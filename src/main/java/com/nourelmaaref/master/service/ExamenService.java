...
public class ExamenService {
     ...
     * @return the list of entities.
     */
    public Page<ExamenDTO> findAllWithEagerRelationships(Pageable pageable) {
        return examenRepository.findAllWithEagerRelationships(pageable).map(examenMapper::toDto);
    }
    ...
    public Optional<ExamenDTO> findOne(Long id) {
        ...
        return examenRepository.findOneWithEagerRelationships(id).map(examenMapper::toDto);
    }
