...
describe('Examen Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Matiere query and add missing value', () => {
      ...
      const nomMatiere: IMatiere = { id: 83852 };
      examen.nomMatiere = nomMatiere;
    ...
    it('Should call Classe query and add missing value', () => {
      const examen: IExamen = { id: 456 };
      const nomClasse: IClasse = { id: 37488 };
      examen.nomClasse = nomClasse;
      ...
      const additionalClasses = [nomClasse];
    ...
    it('Should update editForm', () => {
      const examen: IExamen = { id: 456 };
      const nomMatiere: IMatiere = { id: 70983 };
      examen.nomMatiere = nomMatiere;
      const nomClasse: IClasse = { id: 93787 };
      examen.nomClasse = nomClasse;
      ...
      expect(comp.classesSharedCollection).toContain(nomClasse);
