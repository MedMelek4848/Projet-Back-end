...
export class EleveUpdateComponent implements OnInit {
  ...
  egenreValues = Object.keys(Egenre);
  typeDePaiementValues = Object.keys(typeDePaiement);
  ...
  protected loadRelationshipsOptions(): void {
    this.classeService
      ...
      .pipe(map((classes: IClasse[]) => this.classeService.addClasseToCollectionIfMissing<IClasse>(classes, this.eleve?.appartientA)))
