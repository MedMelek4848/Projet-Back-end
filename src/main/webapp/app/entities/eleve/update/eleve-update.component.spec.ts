...
describe('Eleve Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Classe query and add missing value', () => {
      ...
      const appartientA: IClasse = { id: 44322 };
      eleve.appartientA = appartientA;
      ...
      const additionalClasses = [appartientA];
    ...
    it('Should update editForm', () => {
      const eleve: IEleve = { id: 456 };
      const appartientA: IClasse = { id: 38186 };
      eleve.appartientA = appartientA;

      activatedRoute.data = of({ eleve });
      comp.ngOnInit();

      expect(comp.classesSharedCollection).toContain(appartientA);
