...
export class AbsenceUpdateComponent implements OnInit {
  ...
  protected updateForm(absence: IAbsence): void {
    ...
    this.elevesSharedCollection = this.eleveService.addEleveToCollectionIfMissing<IEleve>(
      this.elevesSharedCollection,
  ...
  protected loadRelationshipsOptions(): void {
    this.eleveService
      ...
      .pipe(map((eleves: IEleve[]) => this.eleveService.addEleveToCollectionIfMissing<IEleve>(eleves, this.absence?.matriculeEleve)))
    ...
    this.matiereService
      ...
      .pipe(
        map((matieres: IMatiere[]) => this.matiereService.addMatiereToCollectionIfMissing<IMatiere>(matieres, this.absence?.nomMatiere))
      )
