...
export class PaiementUpdateComponent implements OnInit {
  ...
  protected updateForm(paiement: IPaiement): void {
    ...
    this.elevesSharedCollection = this.eleveService.addEleveToCollectionIfMissing<IEleve>(this.elevesSharedCollection, paiement.matricule);
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.eleveService
      ...
      .pipe(map((eleves: IEleve[]) => this.eleveService.addEleveToCollectionIfMissing<IEleve>(eleves, this.paiement?.matricule)))
