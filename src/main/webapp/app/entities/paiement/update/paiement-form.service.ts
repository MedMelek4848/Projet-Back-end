...
type PaiementFormGroupContent = {
  ...
  modeDePaiement: FormControl<IPaiement['modeDePaiement']>;
  numeroTranche: FormControl<IPaiement['numeroTranche']>;
  typeDePaiement: FormControl<IPaiement['typeDePaiement']>;
  montantPaye: FormControl<IPaiement['montantPaye']>;
  matricule: FormControl<IPaiement['matricule']>;
};
...
export class PaiementFormService {
  createPaiementFormGroup(paiement: PaiementFormGroupInput = { id: null }): PaiementFormGroup {
    ...
    return new FormGroup<PaiementFormGroupContent>({
      ...
      modeDePaiement: new FormControl(paiementRawValue.modeDePaiement),
      numeroTranche: new FormControl(paiementRawValue.numeroTranche),
      typeDePaiement: new FormControl(paiementRawValue.typeDePaiement),
      montantPaye: new FormControl(paiementRawValue.montantPaye),
      matricule: new FormControl(paiementRawValue.matricule),
    });
  }
