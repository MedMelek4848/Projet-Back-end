...
describe('Note Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Eleve query and add missing value', () => {
      ...
      const matriculeEleve: IEleve = { id: 60070 };
      note.matriculeEleve = matriculeEleve;
    ...
    it('Should call Examen query and add missing value', () => {
      const note: INote = { id: 456 };
      const nomExamen: IExamen = { id: 79878 };
      note.nomExamen = nomExamen;
      ...
      const additionalExamen = [nomExamen];
    ...
    it('Should update editForm', () => {
      const note: INote = { id: 456 };
      const matriculeEleve: IEleve = { id: 11223 };
      note.matriculeEleve = matriculeEleve;
      const nomExamen: IExamen = { id: 75340 };
      note.nomExamen = nomExamen;
      ...
      expect(comp.examenSharedCollection).toContain(nomExamen);
